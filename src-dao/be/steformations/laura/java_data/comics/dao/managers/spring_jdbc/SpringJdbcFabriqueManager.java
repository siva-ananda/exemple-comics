...
public class SpringJdbcFabriqueManager implements FabriqueManagers{
	...
	public SpringJdbcFabriqueManager() {
		super();
		javax.sql.DataSource dataSource = new org.springframework.jdbc.datasource.DriverManagerDataSource("jdbc:postgresql://localhost/comics-java", "postgres", "postgres");
